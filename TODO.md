...
- [ ] 관절별 소프트 리밋 실측 (`05_find_limits.py`) — 완료: J2, J3, J5 (EPROM 기록됨). J1/J4는 연속 관절(±176° 클램프). **남음: J6(ID 21)**
- [x] 자중 토크 → 캡 확정: 정적 측정 ×1.5는 움직임에 부족(포화·리플렉스 오탐) → J1 200, J2 300, J3 250, J4/J5 200, J6 250. 자가진단 최대 부하 J2 224/300 등 여유 확인. **EPROM 영구화(10_persist_caps) 실행은 아직**
...
- [ ] 리플렉스 하드웨어 튜닝 — 블랙박스 8건 분석으로 판정 규칙 수정(위치 기반 진행량)까지 완료. **남음: 새 규칙으로 8절 절차(J4 왕복 10회 오탐 0 / 잡기 감지 / r 복구) 공식 확인**
